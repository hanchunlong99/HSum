...
if __name__ == '__main__':
    ...
    parser.add_argument("-bert_data_path", default='../data/数据集保存/')
    parser.add_argument("-model_path", default='../models')
    parser.add_argument("-result_path", default='../results/')
    parser.add_argument("-temp_dir", default='../temp/base')
    parser.add_argument("-ext_model", default='../models/ext/model_step_46000.pt', help='抽取式参数加载路径')
    ...
    parser.add_argument('-log_file', default='../logs/cnndm_abs_test.log')
    parser.add_argument('-seed', default=666, type=int)

    parser.add_argument("-test_all", type=str2bool, nargs='?',const=True,default=False)
    parser.add_argument("-test_from", default='../models/ext/model_step_47000.pt')
